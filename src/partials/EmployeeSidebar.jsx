...
function EmployeeSidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pr-3 sm:px-2 overflow-y-auto">
          {/* Close button */}
          <button
            ref={trigger}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("/employee/profile") && "bg-slate-900"
                }`}
              >
                <NavLink
                  to="/employee/profile"
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname === "/employee/leave-application" && "bg-slate-900"
                }`}
              >
                <NavLink
                  to="/employee/leave-application"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname === "/employee/leave-application"
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("leave") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
